...
INE2013s1.df <- read.delim(file="ine-processed-data/Pre-Normalized APSA2014PaperTables - Obs 1st Scenario.tsv",stringsAsFactors =FALSE,na.strings="-")
INE2013s2.df <- read.delim(file="ine-processed-data/Pre-Normalized APSA2014PaperTables - Obs 2nd Scsnario .tsv",stringsAsFactors =FALSE,na.strings="-")
INE2017s1.df <- read.delim(file="ine-processed-data/Pre-Normalized Comparative Tables 2017 Federal (APSA 2019) - 1erEsc 2017.tsv",stringsAsFactors =FALSE,na.strings="-")
INE2017s2.df <- read.delim(file="ine-processed-data/Pre-Normalized Comparative Tables 2017 Federal (APSA 2019) - 2doEsc+final 2017.tsv",stringsAsFactors =FALSE,na.strings="-")
