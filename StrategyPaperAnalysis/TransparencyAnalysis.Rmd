...
propmatch.df %>% 
  ...
  tbl_summary(by=actortype,
              type = list(everything() ~ "continuous"),
          statistic = list(all_continuous() ~ "{mean} ({sd}) [{min}-{max}]"),
          missing="no",
          label = list("proposer_seat_difference" ~ "Proposer Seat Change","competitive_difference" ~ "Competitive Seat Change","proposer_win_difference"~ " Margin change in winning districts for proposer","proposer_competitive_margin_difference"~"Margin change for proposer in competitive districts" ,"proposer_composite_difference" ~ "Total Composite Score Change",
                       "proposer_packed_difference" ~ "Margin change in districts packed for proposer")
          ) %>%
 as_gt() %>% 
