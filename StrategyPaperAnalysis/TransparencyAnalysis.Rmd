...
counterScore <- function(p1,p2,proposer) {
  ...
  mutate(proposer_composite_difference = 100 * proposer_seat_difference + 10 * competitive_difference + proposer_win_difference)
...
propmatch.df %>% 
  ...
  select("score_difference","split_difference", "competitive_difference", "population_difference", "win_difference","actortype", "proposer_win_difference", "proposer_seat_difference", "proposer_composite_difference") %>%
...
propmatch.df %>% 
  ...
  select("score_difference","split_difference", "competitive_difference", "population_difference", "win_difference","actorf", "proposer_win_difference",  "proposer_seat_difference", "proposer_composite_difference") %>%
...
write_excel_csv(counterprop.df,file="yuc_counterproposals.csv")
